...
def main():
    ...
    ax3.hist(within_dists, bins=20, alpha=0.7, label=f'Within (n={len(within_dists)})', density=True)
    ax3.hist(between_dists, bins=20, alpha=0.7, label=f'Between (n={len(between_dists)})', density=True)
