...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="sandbox-training/epsilon_vae_data_enhanced")
    ...
    parser.add_argument("--save_dir", type=str, default="sandbox-training/epsilon_vae_models_enhanced")
